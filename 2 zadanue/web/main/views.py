...
PLACES = [
    {'id': 0, 'name': 'Вологодский Кремль', 'lat': 59.2239, 'lon': 39.8825},
    {'id': 1, 'name': 'Музей кружева', 'lat': 59.2243, 'lon': 39.8838},
    {'id': 2, 'name': 'Памятник букве О', 'lat': 59.2215, 'lon': 39.8850},
    {'id': 3, 'name': 'Софийский собор', 'lat': 59.2245, 'lon': 39.8828},
    {'id': 4, 'name': 'Дом Петра I', 'lat': 59.2312, 'lon': 39.8970},
    {'id': 5, 'name': 'Памятник Батюшкову', 'lat': 59.2220, 'lon': 39.8845},
]
